...
from college_management_app.models import Subjects, SessionYearModel, Students, Attendance, AttendanceReport, LeaveReportTeacher, Teachers, FeedbackTeachers, CustomUser, Courses, StudentResult
...
def teacher_update_attendance(request):
    ...
    return render(request,"teacher_template/teacher_update_attendance.html",{"subjects":subjects,"session_year_id":session_year_id})
